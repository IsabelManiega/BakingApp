...
public class RecipeStepDetailsFragment extends Fragment implements View.OnClickListener {
    ...
    private static final String MAX_STEP_ID = "max_step_id";
    private static final String VIDEO_POSITION = "video_position";
    private static final String VIDEO_PLAY_STATE = "video_state";
    ...
    public static RecipeStepDetailsFragment newInstance(Step step, int maxStepId) {
        ...
        args.putInt(MAX_STEP_ID, maxStepId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mMaxStepId = getArguments().getInt(MAX_STEP_ID);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(textViewStepDescription != null) {
            textViewStepDescription.setText(mStep.getDescription());
        }
        if(fabNext != null) {
        ...
        if(savedInstanceState != null) {
            mPlayWhenReady = savedInstanceState.getBoolean(VIDEO_PLAY_STATE);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(mPlayer != null) {
            outState.putLong(VIDEO_POSITION, mPlayer.getCurrentPosition());
            outState.putBoolean(VIDEO_PLAY_STATE, mPlayer.getPlayWhenReady());
        }
    }
